...
export const quotes: Quote[] = [
  ...
  {
    id: 33,
    text: '인생에서 가장 중요한 것은 무엇을 얻느냐가 아니라 무엇이 되느냐다.',
    author: '존 러스킨',
    category: 'wisdom',
  },
  {
  ...
  {
    id: 35,
    text: '독서는 완성된 인간을 만들고, 대화는 재치 있는 인간을 만든다.',
    author: '프랜시스 베이컨',
    category: 'wisdom',
  },
  {
  ...
  {
    id: 45,
    text: '용기란 두렵지 않은 것이 아니라, 두려움에도 불구하고 나아가는 것이다.',
    author: '넬슨 만델라',
    category: 'courage',
  },
  {
  ...
  {
    id: 47,
    text: '남을 이기는 자는 강하고, 자신을 이기는 자는 더욱 강하다.',
    author: '노자',
    category: 'wisdom',
  },
  {
  ...
  {
    id: 51,
    text: '기회는 모든 사람에게 주어지지만, 준비된 사람만이 잡을 수 있다.',
    author: '루이 파스퇴르',
    category: 'wisdom',
  },
  {
